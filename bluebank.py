# -*- coding: utf-8 -*-
"""
Created on Mon Aug 18 12:22:19 2025
...
#describe the data for a certain column
...
# for interest rates, a new column is wanted, rate > 0.12 is high, else low
...
purposeplot.plot.bar(color = 'orange')
plt.show()
